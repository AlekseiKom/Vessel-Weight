...
function calculate() {
    ...
    document.write("<br/>" + "<br/>"
     ...
     + "<br/>" + "Кол-во связок и вес в первом контрольном взвешивании: " + piecesSurvNumber1 + " св./шт., " + "весом: " + survNumber1 + " кг."
     + "<br/>" + "Кол-во связок и вес во втором контрольном взвешивании: " + piecesSurvNumber2 + " св./шт., " + "весом: " + survNumber2 + " кг.");
